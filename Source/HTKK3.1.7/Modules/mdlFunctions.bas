...
Public Sub SetupData(pGrid As fpSpread)
                ...
                Else
                    ...
                    Else
                        If GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "0" Then
                            ...
                            Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "85") And mCurrentSheet = 1 Then
    ...
    '                                End If
                ...
                Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "83" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "85" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "70") And fso.FileExists(strDataFileNameBS) Then
                     isNewdataBS = False
                End If
...
Public Function getTemplateTk(ByVal strId As String) As String()
    ...
    Select Case strId
        ...
        Case "02"
            ...
            strResult(2) = "V_55~CB_55~V_57~CB_57~C_59~F_59~I_59~K_59~Dynamic_0"
        ' 03_GTGT / TT28
        Case "04"
            ReDim strResult(3)
        ...
        Case "71"
            ...
            strResult(10) = "H_73~T_73~H_75~T_75~C_37~F_37~I_37~K_37~Dynamic_0"
         ' 05_GTGT /TT28
        Case "72"
            ReDim strResult(3)
        ...
        Case "11"
            ...
            strResult(2) = "D_12~Dynamic_0"
            strResult(3) = "E_41~E_43~J_41~J_43~E_13~G_13~E_44~L_15~Dynamic_0"
        ' 01B_TNDN \ TT28
        Case "12"
            ReDim strResult(3)
            strResult(0) = "D_12~Dynamic_0"
            strResult(1) = "E_7~J_36~J_37~J_38~J_39~J_41~G_42~J_42~J_43~J_44~J_45~J_46~J_47~B_48~Dynamic_0"
        ...
        Case "73"
            ...
            strResult(3) = "P_89~P_91~AP_89~AP_91~M_54~O_54~AI_54~T_54~C_82~Dynamic_0"

...
'            fpsReport.Lock = True
    ...
    ElseIf GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = 59 Then
      fpsReport.PrintFooter = font1 & GetAttribute(GetMessageCellById("0231"), "Msg") & "/n" & GetAttribute(GetMessageCellById("0232"), "Msg") & _
                               "/n" & GetAttribute(GetMessageCellById("0233"), "Msg") & _
                               "/n" & GetAttribute(GetMessageCellById("0234"), "Msg")
    End If
    ...
    Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "11" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "12" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "06" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "05" _
    Or idToKhai = "03" Or idToKhai = "71" Or idToKhai = "72" Or idToKhai = "73" Or idToKhai = "77" Or idToKhai = "80" Or idToKhai = "81" Or idToKhai = "82" Or idToKhai = "83" Or idToKhai = "85" Or idToKhai = "86" Or idToKhai = "87" Or idToKhai = "89") Then
    ...
    dsTK_checkDLT = "~01~02~04~71~72~11~12~73~03~46~47~48~49~15~16~50~51~36~74~75~70~80~81~82~17~42~43~59~76~41~06~77~05~86~87~89~"

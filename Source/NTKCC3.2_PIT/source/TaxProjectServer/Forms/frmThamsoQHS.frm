...
Begin VB.Form frmThamsoQHS 
   ...
   End
End
Attribute VB_Name = "frmThamsoQHS"
...
'    End If
    ...
    If Len(txtDir.Text) = 0 Then
        DisplayMessage "0083", msOKOnly, miInformation
        txtDir.SetFocus
        Exit Sub
    End If
    ...
    End If
            ...
            If txtDir.Text <> spathVat Then
                Dim txt As String
                txt = txtDir.Text & "," & strFile(1) & "," & strFile(2)
...
Private Sub Form_Load()
    SetControlCaption Me, "frmThamsoQHS"
    Call ReadPathFile(App.path & "\configQHS.txt")

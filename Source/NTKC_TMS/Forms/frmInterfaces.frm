...
'str2 = "bs320772222222222   00201200600800100301/0114/06/2006<S01><S>2222222222</S><S>010104~Kg~123~48888~11~0~0~050101~T n~65342.895~543.768~7~0~654.987~010207~Kg~27646.456~0~0~876.456~888.320</S><S>010"
'Barcode_Scaned str2
...
'    End If
    ...
    Else
        ...
        If (Err_des <> "") Then
            If (MsgBox(Err_des & ".Bπn c„ muËn ti’p tÙc?", vbYesNo, Me.Name) = vbNo) Then
                Set rsReturn = Nothing
                blnSuccess = False
                Exit Function
            End If

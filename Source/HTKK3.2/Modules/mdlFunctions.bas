...
Public Function GetAttribute(xmlNodeCell As MSXML.IXMLDOMNode, _
                             pAttributeName As String) As String
...
Public Sub SetAttribute(xmlNodeCell As MSXML.IXMLDOMNode, _
                        pAttributeName As String, _
                        pValue As String)
    On Error Resume Next
...
Public Function GetValidityNode() As MSXML.IXMLDOMNode
    ...
    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "ThreeMonth") = "1" Then
        ...
        Select Case TAX_Utilities_New.ThreeMonths
            ...
            Case "1", "2", "3", "4"
                ValidityDate = GetNgayCuoiQuy(CInt(TAX_Utilities_New.ThreeMonths), CInt(TAX_Utilities_New.Year), iNgayTaiChinh, iThangTaiChinh)
                '            Case "2"
...
Public Sub LoadTemplate(pGrid As fpSpread, Optional IsInterface As Boolean = True)
    ...
    If TAX_Utilities_New.NodeValidity Is Nothing Then TAX_Utilities_New.NodeValidity = GetValidityNode
            ...
            If strKHBS = "" Or strKHBS = "TKCT" Then
                ...
                Else
                    ...
                    If GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "0" Then
                        ...
                        If GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "01" Or GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "02" Or GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "04" Or GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "95" Or GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "71" Then
                    ...
                    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "0" Then
                        ...
                        If GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "80" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "82" Then
                            strDataFileName = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & ".xml"
                        Else
                            strDataFileName = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & ".xml"
                        End If
                    ...
                    Else
                        ...
                        strDataFileName = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & ".xml"
                        '*********************************
                    End If
                End If
            ...
            Else
                ...
                Else
                    ...
                    If GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "0" Then
                        ...
                        If (TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_11" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_1" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "05" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "06" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "86" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "89" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "85" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "90") And mCurrentSheet = 1 Then
                    ...
                    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" Then
                        ...
                        ' Doi voi to khai thang TNCN
                        If (TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_11" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_1" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "05" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "06" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "81" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "70" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "85") And mCurrentSheet = 1 Then
                    ...
                    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "ThreeMonth") = "1" Then
                        ...
                        If (GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "74" Or GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "75") And strQuy = "TK_TU_THANG" Then
                        ...
                        Else
                            ...
                            ' Doi voi to khai quy TNCN
                            If (TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_11" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "11" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "12" Or TAX_Utilities_New.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "73") And mCurrentSheet = 1 Then
                    ...
                    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "0" Then
                        ...
                        If GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "80" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "82" Then
                            ...
                            If lSheet = 0 Then
                                ...
                                ' Neu chua ton tai lan bo sung nay va lan bo sung la 1 thi se lay to khai chinh thuc de cap nhat du lieu
                                If Trim(strSolanBS) = "1" Then
                                    strDataFileBS = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & ".xml"
                                Else
                                    ' Neu bo sung tu lan thu 2 tro di thi se lay lan gan voi lan bo sung nhat
                                    strDataFileBS = TAX_Utilities_New.DataFolder & "bs" & Val(strSolanBS) - 1 & "_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & ".xml"
                                End If
                            End If
                        ...
                        ElseIf GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = "03" Then
                            'Data file not contain Day from and to.
                            strDataFileName = TAX_Utilities_New.DataFolder & "bs" & strSolanBS & "_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & ".xml"

                            If lSheet = 0 Then

                                ' Neu chua ton tai lan bo sung nay va lan bo sung la 1 thi se lay to khai chinh thuc de cap nhat du lieu
                                If Trim(strSolanBS) = "1" Then
                                    strDataFileBS = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & ".xml"
                                Else
                                    ' Neu bo sung tu lan thu 2 tro di thi se lay lan gan voi lan bo sung nhat
                                    strDataFileBS = TAX_Utilities_New.DataFolder & "bs" & Val(strSolanBS) - 1 & "_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & ".xml"
                                End If
                            End If
                            ...
                            If Not fso.FileExists(strDataFileName) And mCurrentSheet = 1 Then
                                ...
                                Else
                                    ' Neu bo sung tu lan thu 2 tro di thi se lay lan gan voi lan bo sung nhat
                                    strDataFileName = TAX_Utilities_New.DataFolder & "bs" & Val(strSolanBS) - 1 & "_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace$(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace$(TAX_Utilities_New.LastDay, "/", "") & ".xml"
                                End If
                            End If
                    ...
                    Else
                        ...
                        'Data file not contain Day from and to.
                        strDataFileName = TAX_Utilities_New.DataFolder & "bs" & strSolanBS & "_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & ".xml"

                        If lSheet = 0 Then

                            ' Neu chua ton tai lan bo sung nay va lan bo sung la 1 thi se lay to khai chinh thuc de cap nhat du lieu
                            If Trim(strSolanBS) = "1" Then
                                strDataFileBS = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & ".xml"
                            Else
                                ' Neu bo sung tu lan thu 2 tro di thi se lay lan gan voi lan bo sung nhat
                                strDataFileBS = TAX_Utilities_New.DataFolder & "bs" & Val(strSolanBS) - 1 & "_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & ".xml"
                            End If
                        End If
                        ...
                        If Not fso.FileExists(strDataFileName) And mCurrentSheet = 1 Then
                            ...
                            Else
                                ' Neu bo sung tu lan thu 2 tro di thi se lay lan gan voi lan bo sung nhat
                                strDataFileName = TAX_Utilities_New.DataFolder & "bs" & Val(strSolanBS) - 1 & "_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & ".xml"
                            End If
                        End If
...
Public Sub GetCellSpan(pGrid As fpSpread, _
                       pCol As Long, _
                       pRow As Long, _
                       Optional pNumsRow As Variant, _
                       Optional pNumsCol As Variant)
    On Error GoTo ErrorHandle
...
Public Function GetCellID(pGrid As fpSpread, _
                          ByVal pCol As Long, _
                          ByVal pRow As Long) As String
...
Public Function ValidNumber(ByVal s As String, _
                            Optional max As Integer, _
                            Optional min As Integer = 0) As Boolean
    Dim i       As Long
...
Public Sub SaveErrorLog(pFormName As String, _
                        pFunctionName As String, _
                        pErrorNumber As Long, _
                        pErrorDesc As String)
    Dim msg     As String
    Dim FileNum As Long
    Dim path    As String
...
Private Function CreateSections(xmlNodeSections As MSXML.IXMLDOMNode, _
                                pSheet As String) As String
    On Error GoTo ErrorHandle
...
Public Sub CreateExcelBook()
    ...
    For i = 0 To TAX_Utilities_New.xmlDataCount
        ...
        If GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(i), "Active") <> "0" Then
            ...
            If i = 0 Then
                strDataBarcode(i) = format(iNgayTaiChinh, "0#") & "/" & format(iThangTaiChinh, "0#") & GetAttribute(TAX_Utilities_New.NodeValidity, "StartDate") & IIf(GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1", TAX_Utilities_New.FirstDay & TAX_Utilities_New.LastDay, "") & CreateSections(xmlNodeSections, GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(i), "ID"))
            Else
...
Private Sub ResetRow(ByVal xmlCellNode As MSXML.IXMLDOMNode, _
                     fpsGrid As fpSpread, _
...
Public Function CheckTaxCode(ms1 As String, _
                             ms2 As String, _
                             ms3 As String, _
                             ms4 As String, _
                             ms5 As String, _
...
Public Function IsValidTaxId(strTaxID As String) As Boolean
    ...
    If Not IsNumeric(strTaxID) Then Exit Function

    If Len(strTaxID) <> 10 And Len(strTaxID) <> 13 Then Exit Function

    If Not CheckTaxCode(Mid$(strTaxID, 1, 1), Mid$(strTaxID, 2, 1), Mid$(strTaxID, 3, 1), Mid$(strTaxID, 4, 1), Mid$(strTaxID, 5, 1), Mid$(strTaxID, 6, 1), Mid$(strTaxID, 7, 1), Mid$(strTaxID, 8, 1), Mid$(strTaxID, 9, 1), Mid$(strTaxID, 10, 1)) Then
        Exit Function
    End If
...
'****************************************************
Public Function GetDynRowCount(pGrid As fpSpread, _
                               xmlNodeCells As MSXML.IXMLDOMNode, _
                               Optional ByRef lReportRows As Long, _
                               Optional ByRef lMinRow As Long, _
                               Optional lMaxRow As Long)
    Dim xmlNodeCell As MSXML.IXMLDOMNode
...
Public Sub InsertRow(fpSpread1 As fpSpread, _
                     ByVal pRow As Long, _
                     lRows As Long, _
                     Optional blnFillingData As Boolean = False)
    On Error GoTo ErrorHandle
...
Public Sub IncreaseRowInDOM(fpSpread1 As fpSpread, _
                            xmlDomData As MSXML.DOMDocument, _
                            ByVal pRow As Long, _
                            ByVal lRows As Long, _
                            ByVal lRow2s As Long)
    On Error GoTo ErrorHandle
...
Public Function KiemTraNgayTaiChinh(strDate As String, _
                                    Optional blnShowMessage As Boolean = True) As Boolean
...
Public Function GetNgayDauQuy(q As Integer, _
                              Y As Integer, _
                              dNgayTaiChinh As Integer, _
                              dThangTaiChinh As Integer) As Date
...
Public Function GetNgayCuoiQuy(q As Integer, _
                               Y As Integer, _
                               dNgayTaiChinh As Integer, _
                               dThangTaiChinh As Integer) As Date
...
Public Function NgayCuoiNamTaiChinh(Y As Integer, _
                                    dThangTaiChinh As Integer, _
                                    dNgayTaiChinh As Integer) As Date
    Dim dNgayTC As Date
...
Public Function SaveSessionValueToFile(ByVal strFileName As String, _
                                       Optional ByVal blnPrintingSession As Boolean = True, _
                                       Optional ByVal blnDataSession As Boolean = True) As Boolean
    Dim lFileNum     As Long
    Dim intCtrl      As Integer
    Dim strData      As String
    Dim arrStrData() As String
...
Public Sub SetupDataKHBS(pGrid As fpSpread)
    ...
    Else
        ...
        ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "0" Then
            'Data file contain Day from and to.
            strDataFileName = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & ".xml"
            strKHBSDataFileName = TAX_Utilities_New.DataFolder & "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & "_" & TAX_Utilities_New.DateKHBS & ".xml"
        ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "1" Then
            'Data file contain Day from and to.
            strDataFileName = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Day & TAX_Utilities_New.month & TAX_Utilities_New.Year & ".xml"
            strKHBSDataFileName = TAX_Utilities_New.DataFolder & "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Day & TAX_Utilities_New.month & TAX_Utilities_New.Year & "_" & TAX_Utilities_New.DateKHBS & ".xml"
        Else
            'Data file not contain Day from and to.
            strDataFileName = TAX_Utilities_New.DataFolder & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & ".xml"
            strKHBSDataFileName = TAX_Utilities_New.DataFolder & "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(lSheet), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & TAX_Utilities_New.DateKHBS & ".xml"
            '*********************************
        End If
    End If
        ...
        If InStr(1, TAX_Utilities_New.Data(lSheet).parseError.errorCode, "2146697210") <> 0 Then
            ...
            If TAX_Utilities_New.Data(0).parseError.reason <> vbNullString Then
                If InStr(1, TAX_Utilities_New.Data(0).parseError.errorCode, "2146697210") <> 0 Then
                    ...
                    If GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "05" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "06" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "08" Or GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "09" Then
    ...
    With pGrid
        ...
        If isNewdataBS = False Then
            If GetAttribute(TAX_Utilities_New.NodeMenu, "ID") = "01" Then
                ...
                .Row = lRow_temp
                '.Formula = ""
                .value = GetAttribute(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell")(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell").length - 11), "Value")
                ...
                .value = GetAttribute(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell")(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell").length - 10), "Value")
            Else
                ...
                .Row = lRow_temp
                '.Formula = ""
                .value = GetAttribute(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell")(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell").length - 7), "Value")
                ...
                '.Formula = ""
                '.value = GetAttribute(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell").length - 1), "Value")
                .value = GetAttribute(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell")(TAX_Utilities_New.Data(TAX_Utilities_New.NodeValidity.childNodes.length - 1).getElementsByTagName("Cell").length - 6), "Value")
            End If
        End If
...
Public Sub FillData(pGrid As fpSpread, _
                    xmlNodeList As MSXML.IXMLDOMNodeList, _
                    mCurrentSheet As Integer, _
...
Private Function GetLastfileName() As String
    ...
    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Month") <> "1" Then
        'Data file contain Day from and to.
        strDataFileName = "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "")
    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "1" Then
        'Data file contain Day.
        strDataFileName = "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_New.Day & TAX_Utilities_New.month & TAX_Utilities_New.Year
    Else
        'Data file not contain Day from and to.
        strDataFileName = "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_New.Year
        '*********************************
    End If
    ...
    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Month") <> "1" Then
        'Data file contain Day from and to.
        GetLastfileName = TAX_Utilities_New.DataFolder & "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & Replace(TAX_Utilities_New.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_New.LastDay, "/", "") & "_" & GetLastfileName & ".xml"
    ElseIf GetAttribute(TAX_Utilities_New.NodeMenu, "Day") = "1" And GetAttribute(TAX_Utilities_New.NodeMenu, "Month") = "1" Then
        'Data file contain Day.
        GetLastfileName = TAX_Utilities_New.DataFolder & "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_New.Day & TAX_Utilities_New.month & TAX_Utilities_New.Year & "_" & GetLastfileName & ".xml"
    Else
        'Data file not contain Day from and to.
        GetLastfileName = TAX_Utilities_New.DataFolder & "KHBS_" & GetAttribute(TAX_Utilities_New.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_New.Year & "_" & GetLastfileName & ".xml"
        '*********************************
    End If
...
Public Function getTemplateTk(ByVal strId As String) As String()
    ...
    Select Case strId
        ...
        Case "01"
            ...
            strResult(2) = "D_52~D_53~K_52~K_53~K_55~L_55~O_55~L_14~B_18~D_20~P_20~N_55~Dynamic_0"
        ...
        Case "04"
            ...
            strResult(2) = "E_56~O_56~E_58~O_58~C_60~F_60~I_60~M_60~Dynamic_0"
        ...
        Case "71"
            ...
            strResult(1) = "L_43~R_43~X_43~Dynamic_0"
            strResult(2) = "B_45~C_45~K_45~Q_45~W_45~AE_45~Dynamic_1"
            strResult(3) = "L_47~R_47~X_47~Dynamic_0"
            strResult(4) = "B_49~C_49~K_49~Q_49~W_49~AE_49~Dynamic_1"
            strResult(5) = "L_51~R_51~X_51~Dynamic_0"
            strResult(6) = "B_53~C_53~K_53~Q_53~W_53~AE_53~Dynamic_1"
            strResult(7) = "L_55~R_55~X_55~L_25~R_25~X_25~Dynamic_0"
            strResult(8) = "B_57~C_57~K_57~Q_57~W_57~AE_57~Dynamic_1"
            strResult(9) = "S_60~O_62~E_25~Dynamic_0"
            strResult(10) = "H_73~T_73~H_75~T_75~C_37~F_37~I_37~Dynamic_0"
        ...
        Case "72"
            ...
            strResult(2) = "H_55~R_55~H_57~R_57~C_54~F_54~I_54~Dynamic_0"
        ...
        Case "11"
            ...
            strResult(1) = "K_22~K_23~K_24~K_25~K_26~K_27~K_28~K_29~K_30~K_31~K_32~K_33~B_34~Dynamic_0"
            strResult(2) = "D_11~D_12~Dynamic_0"
            strResult(3) = "E_41~E_43~J_41~J_43~E_13~G_13~E_44~L_15~Dynamic_0"

            ' 01B_TNDN \ TT28
        Case "12"
            ReDim strResult(3)
            strResult(0) = "D_12~Dynamic_0"
            strResult(1) = "E_6~E_7~J_36~J_37~J_38~J_39~J_41~G_42~J_42~J_43~J_44~J_45~J_46~J_47~B_48~Dynamic_0"
            strResult(2) = "I_52~I_54~D_52~D_54~E_14~G_14~L_14~Dynamic_0"
        ...
        Case "03"
            ...
            strResult(1) = "O_23~O_25~O_26~O_27~O_28~O_29~O_30~O_31~O_32~O_33~O_34~O_35~O_36~O_37~O_38~O_40~O_41~O_42~O_43~O_44~O_45~O_46~O_47~O_48~O_49~O_50~O_51~O_52~O_53~O_54~Dynamic_0"
            strResult(2) = "D_8~Dynamic_0"
        ...
        Case "15"
            ...
            strResult(1) = "U_41~U_42~U_44~U_45~U_46~U_48~U_49~U_50~U_52~U_53~U_54~Dynamic_0"
        ...
        Case "06"
            ...
            strResult(3) = "W_50~W_52~AJ_50~AJ_52~I_15~J_15~K_15~AG_15~AJ_15~AN_15~Dynamic_0"
        ...
        Case "80"
            ...
            strResult(1) = "Q_30~W_30~AF_30~AO_30~Q_31~W_31~AF_31~AO_31~Q_33~W_33~AF_33~AO_33~Q_34~W_34~AF_34~AO_34~W_35~AF_35~Q_36~W_36~AF_36~AO_36~Q_37~W_37~AF_37~AO_37~W_38~AF_38~Q_39~W_39~AF_39~AO_39~Q_40~W_40~AF_40~AO_40~W_41~AF_41~Q_42~W_42~AF_42~AO_42~Q_43~W_43~AF_43~AO_43~Dynamic_0"
            strResult(2) = "P_47~AQ_47~P_49~AQ_49~M_23~N_23~O_23~S_23~AD_23~Dynamic_0"
        ...
        Case "82"
            ...
            strResult(1) = "O_30~T_30~AB_30~AJ_30~O_31~T_31~AB_31~AJ_31~T_32~AB_32~O_33~T_33~AB_33~AJ_33~O_34~T_34~AB_34~AJ_34~T_35~AB_35~Dynamic_0"
            strResult(2) = "M_43~AL_43~M_45~AL_45~M_23~N_23~O_23~S_23~Z_23~Dynamic_0"

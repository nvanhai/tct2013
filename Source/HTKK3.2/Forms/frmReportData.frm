...
'            fpsReport.Lock = True
    ...
    ElseIf GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = 50 Or GetAttribute(TAX_Utilities_New.NodeValidity.parentNode, "ID") = 51 Then
        fpsReport.PrintFooter = font1 & GetAttribute(GetMessageCellById("0127"), "Msg") & "/n/fb0/fi0/fu0" & GetAttribute(GetMessageCellById("0179"), "Msg") & "/n" & GetAttribute(GetMessageCellById("0180"), "Msg") & "/n" & GetAttribute(GetMessageCellById("0181"), "Msg") & "/n" & GetAttribute(GetMessageCellById("0182"), "Msg")
    ...
    dsTK_checkDLT = "~01~02~04~71~72~11~12~73~03~46~47~48~49~15~16~50~51~36~74~75~70~80~81~82~17~42~43~59~76~41~06~77~05~86~87~89~90~95~92~94~"

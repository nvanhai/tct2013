...
SELECT dtl.hdr_id
     , dtl.row_id  so_tt
     , MAX(dtl.tong_so_thue_pn1) tong_so_thue_pn1
     , MAX(dtl.tong_so_thue_pn2) tong_so_thue_pn2
     ...
     , MAX(dtl.kdl_tong_so_thue_pn1) kdl_tong_so_thue_pn1
     , MAX(dtl.kdl_tong_so_thue_pn2) kdl_tong_so_thue_pn2
     , MAX(dtl.kdl_ten_cs) kdl_ten_cs
     , MAX(dtl.kdl_dia_chi) kdl_dia_chi
     , MAX(dtl.kdl_ma_so_thue) kdl_ma_so_thue
     , MAX(dtl.kdl_hang_hoa_chiu_thue_5) kdl_hang_hoa_chiu_thue_5
     , MAX(dtl.kdl_hang_hoa_chiu_thue_10) kdl_hang_hoa_chiu_thue_10
     , MAX(dtl.kdl_Tong) kdl_Tong
     , MAX(dtl.kdl_so_thue_pn1) kdl_so_thue_pn1
     , MAX(dtl.kdl_so_thue_pn2) kdl_so_thue_pn2
FROM rcv_gdien_tkhai gd,
(
  SELECT tkd.hdr_id,
         tkd.row_id,
       ...
       DECODE(gdien.cot_03, tkd.ky_hieu, tkd.gia_tri, NULL) dia_chi,
       DECODE(gdien.cot_04, tkd.ky_hieu, tkd.gia_tri, NULL) ma_so_thue,
       DECODE(gdien.cot_05, tkd.ky_hieu, tkd.gia_tri, NULL) hang_hoa_chiu_thue_5,
       DECODE(gdien.cot_06, tkd.ky_hieu, tkd.gia_tri, NULL)  hang_hoa_chiu_thue_10,
       DECODE(gdien.cot_07, tkd.ky_hieu, tkd.gia_tri, NULL) Tong,
       DECODE(gdien.cot_08, tkd.ky_hieu, tkd.gia_tri, NULL) so_thue_pn1,
       DECODE(gdien.cot_09, tkd.ky_hieu, tkd.gia_tri, NULL) so_thue_pn2,
       DECODE(gdien.cot_10, tkd.ky_hieu, tkd.gia_tri, NULL) tong_so_thue_pn1,
       DECODE(gdien.cot_11, tkd.ky_hieu, tkd.gia_tri, NULL) tong_so_thue_pn2,
       DECODE(gdien.cot_02, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_ten_cs,
       DECODE(gdien.cot_03, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_dia_chi,
       DECODE(gdien.cot_04, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_ma_so_thue,
       DECODE(gdien.cot_05, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_hang_hoa_chiu_thue_5,
       DECODE(gdien.cot_06, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_hang_hoa_chiu_thue_10,
       DECODE(gdien.cot_07, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_Tong,
       DECODE(gdien.cot_08, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_so_thue_pn1,
       DECODE(gdien.cot_09, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_so_thue_pn2,
       DECODE(gdien.cot_10, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_tong_so_thue_pn1,
       DECODE(gdien.cot_11, ctieu.ky_hieu, ctieu.kieu_dlieu, NULL) kdl_tong_so_thue_pn2
  FROM rcv_tkhai_dtl tkd,
       rcv_gdien_tkhai gdien,
       rcv_map_ctieu ctieu
  WHERE (ctieu.gdn_id = gdien.id)
...
SELECT dtl.hdr_id
     ...
     , MAX(dtl.Tong_so_xe_br) Tong_so_xe_br
...
(
  SELECT tkd.hdr_id,
         ...
         gdien.so_tt,
    	   ...
    	   DECODE(gdien.cot_04, tkd.ky_hieu, tkd.gia_tri, NULL) Tong_so_xe_br,
    	   DECODE(gdien.cot_05, tkd.ky_hieu, tkd.gia_tri, NULL) So_xe_ban_td,
         DECODE(gdien.cot_06, tkd.ky_hieu, tkd.gia_tri, NULL) Gia_tren_hd,
         DECODE(gdien.cot_07, tkd.ky_hieu, tkd.gia_tri, NULL) Ghi_chu
  FROM rcv_tkhai_dtl tkd,
       rcv_gdien_tkhai gdien,
       rcv_map_ctieu ctieu
  WHERE (ctieu.gdn_id = gdien.id)

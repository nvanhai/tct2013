...
Private Sub cboNganhKD_Click()
    ...
    If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "98" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "92" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "93" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "89" Then
...
Dim d, m, Y As Integer
    If chkCondensate.value = 1 Then
        ...
        If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "92" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "98") Then
            strLoaiTKThang_PS = "TK_LANPS"
        ElseIf (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "93") Then
    ...
    If strLoaiSacThue = "ToKhaiGTGT" Then
        ...
        If chkTkhaiThang.value = 1 Then
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "71" Then
             ...
             ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "98" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "92" Then
                 strQuy = "TK_THANG"
                ...
                'SetValueToList GetAttribute(TAX_Utilities_v2.NodeMenu, "ID")
                SetValueToListDK ("1")
            ...
            End If
        Else
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "71" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "98" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "92" Then
        ...
        Else
            ...
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "70" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "55" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "06" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "72" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "73" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "81" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "90" Then
                ...
                If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "90" Then
                    Frame2.Top = 2000
                ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "73" Then
                    Frame2.Top = 1920
                    txtMonth.Visible = False
                    lblMonth.Visible = False
                    lblQuy.Visible = True
...
'                    Frame2.Top = 2700
'                    Set lblNganhKD.Container = frmKy
'                    lblNganhKD.caption = TAX_Utilities_v2.Convert(GetAttribute(GetMessageCellById("0237"), "Msg"), UNICODE, TCVN)
'                    lblNganhKD.Top = 1600
'                    lblNganhKD.Left = 120
'
'
...
'         If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "73" Then
...
Private Sub chkTKLanPS_Click()
    ...
    dTem = DateAdd("D", -1, Date)
    dtem1 = DateAdd("M", -1, Date)
    If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "98" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "92" Then
        If chkTKLanPS.value = 1 Or chkTKhaiLanXB.value = 1 Then
            lblNgay.Visible = True
            txtDay.Visible = True
         Else
    ...
    If chkTKLanPS.value = 1 Then
        ...
        Else
            ...
            If varMenuId = "70" Or varMenuId = "55" Or varMenuId = "06" Or varMenuId = "72" Or varMenuId = "73" Or varMenuId = "81" Or varMenuId = "90" Then
...
'ngay 21/01/2011
    If (cmbQuy.Text & "/" & txtYear.Text <> TAX_Utilities_v2.ThreeMonths & "/" & yChange) Then
        If GetAttribute(TAX_Utilities_v2.NodeMenu, "Year") = "1/2" And txtNgayCuoi.Enabled And txtNgayDau.Enabled Then
            Call initNgayDauNgayCuoiKy(CInt(txtYear.Text), cmbQuy.ListIndex)
        End If
        LoadGrid
    End If
...
Public Sub cmdOK_Click()
    ...
    If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "95" Then
    ...
    If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "64" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "07" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "91" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "27" Then
        txtDay_LostFocus
        txtMonth_LostFocus
        txtYear_LostFocus
    End If
    
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "37" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "38" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "40") And Val(txtYear.Text) >= 2010 Then
        DisplayMessage "0176", msOKOnly, miInformation
        Exit Sub
    End If
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "53" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "54") And ((Val(txtYear.Text) = 2010 And txtMonth.Text <> "01") Or Val(txtYear.Text) >= 2011) Then
        DisplayMessage "0176", msOKOnly, miInformation
        Exit Sub
    End If
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "39") And ((Val(txtYear.Text) = 2010 And txtMonth.Text <> "01") Or Val(txtYear.Text) >= 2011) Then
        DisplayMessage "0176", msOKOnly, miInformation
        Exit Sub
    End If
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "15" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "50") And Val(txtYear.Text) = 2010 And txtMonth.Text = "01" Then
        DisplayMessage "0177", msOKOnly, miInformation
        Exit Sub
    End If
    
    ' validate cho to 04TBAC
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "91") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "64") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "07") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "27") Then
...
'        End If
    ...
    ' validate cho to 04TBAC
'    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "92" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "98" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "93" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "89") Then
...
'    End If
    ...
    If CInt(txtYear.Text) < CInt(Right$(GetAttribute(TAX_Utilities_v2.NodeMenu.childNodes(0), "StartDate"), 4)) Then
        ...
        Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "94" Then
            ...
            If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "71" Then
                ...
                ElseIf strQuy = "TK_QUY" Then
                    ...
                    If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "01" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "02" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "04" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "71" Then

                        If (Val(TAX_Utilities_v2.ThreeMonths) < 3 And Val(TAX_Utilities_v2.Year) = 2013) Or Val(TAX_Utilities_v2.Year) < 2013 Then
    ...
    ElseIf strKieuKy = KIEU_KY_QUY Then
        If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "73" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "56" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "55") And chkTKLanPS.value = "1" Then
        ElseIf (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "55") And chkTKLanPS.value = "0" Then
        ...
        End If
        ' BC 26
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "68" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "14" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "13" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "18" Then
            If strQuy = "TK_THANG" Then
                 If Not CheckPeriod(txtMonth.Text, txtYear.Text) Then
                    txtMonth.SetFocus
                    Exit Sub
        ...
        ' To khai 02/TNDN
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "73" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "56" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "55" Then
            If txtDay.Text <> "" Then
        ...
        '01/KK-TTS
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "23" Then
            TAX_Utilities_v2.FirstDay = txtNgayDau.Text
            TAX_Utilities_v2.LastDay = txtNgayCuoi.Text
        End If
    ElseIf strKieuKy = KIEU_KY_NAM Then
        ...
        ' 02/TNDN-DK
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "93" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "89" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "87" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "97" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "77" _
        Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "88" Then
            TAX_Utilities_v2.FirstDay = txtNgayDau.Text
            TAX_Utilities_v2.LastDay = txtNgayCuoi.Text
            ...
            If Right$(txtNgayDau.Text, 4) <> TAX_Utilities_v2.Year Then
        ...
        ' QT TNCN
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "76" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "59" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "43" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "41" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "17" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "26" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "45" Then
            TAX_Utilities_v2.FirstDay = txtNgayDau.Text
            TAX_Utilities_v2.LastDay = txtNgayCuoi.Text
   ...
   ' dntai them vao ngay 08/05/2011
    ElseIf strKieuKy = "H_Y" Then
        ' BC 26
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "68" Then
            If strQuy = "TK_THANG" Then
                 If Not CheckPeriod(txtMonth.Text, txtYear.Text) Then
                    txtMonth.SetFocus
                    Exit Sub
    ...
    ElseIf strKieuKy = KIEU_KY_NGAY_NAM Then
        ...
        If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue <> "17") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue <> "41") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue <> "42") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue <> "43") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue <> "26") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue <> "59") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue <> "44") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue <> "45") Then

            If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "80") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "82") Then
...
'                End If
            Else
                'Cap nhat to 02/PHLP
                If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "03" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "88" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "87" _
                Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "97" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "93" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "89" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "77" Then
                Else
...
'htphuong add check valid ngay mau 05/GTGT
   ...
   If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "36") Then
        If strQuy = "TK_THANG" Then
            If (Val(TAX_Utilities_v2.month) >= 7 And Val(TAX_Utilities_v2.Year) = 2013) Or Val(TAX_Utilities_v2.Year) > 2013 Then
   ...
   End If
    ...
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "74" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "75" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "23") And strQuy = "TK_TU_THANG" Then
    ...
    ' 01/KK-TTS
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "23") And strQuy = "TK_TU_THANG" Then
            If Trim(txtNgayDau.Text) <> "" Then
                 strTempValue = Trim(txtNgayDau.Text)
                 dNgayDau = objCvt.ToDate("01" & "/" & strTempValue, "DD/MM/YYYY")
            End If
    ...
    ' 02/TNDN-DK
    If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "93" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "89" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "87" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "97" _
    Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "77" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "88" Then
            If Trim(txtNgayDau.Text) <> "" Then
                 strTempValue = Trim(txtNgayDau.Text)
                 dNgayDau = objCvt.ToDate("01" & "/" & strTempValue, "DD/MM/YYYY")
            End If
    ...
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "70" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "55" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "06" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "72" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "73" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "56" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "71" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "81" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "73" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "56" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "90") And chkTKLanPS.value = "1" Then
    ...
    'set data
    TAX_Utilities_v2.Year = txtYear.Text
    If strKieuKy = KIEU_KY_THANG Then
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "01" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "02" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "04" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "71" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "36" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "25" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "96" _
        Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "94" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "98" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "92" Then

            If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "71" Then
                If strQuy = "TK_THANG" Then
                    TAX_Utilities_v2.month = txtMonth.Text
                    TAX_Utilities_v2.ThreeMonths = vbNullString
                    TAX_Utilities_v2.FirstDay = vbNullString
                    TAX_Utilities_v2.LastDay = vbNullString
                ElseIf strQuy = "TK_QUY" Then
                    TAX_Utilities_v2.month = txtMonth.Text
                    TAX_Utilities_v2.ThreeMonths = cmbQuy.Text
                    TAX_Utilities_v2.FirstDay = vbNullString
                    TAX_Utilities_v2.LastDay = vbNullString
                ElseIf strQuy = "TK_LANPS" Then
                    TAX_Utilities_v2.ThreeMonths = "1"
                    TAX_Utilities_v2.month = txtMonth.Text
                    TAX_Utilities_v2.Day = txtDay.Text
                    TAX_Utilities_v2.month = txtMonth.Text
                End If
            ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "98" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "92" Then
                If strQuy = "TK_THANG" Then
                    TAX_Utilities_v2.month = txtMonth.Text
                    TAX_Utilities_v2.ThreeMonths = vbNullString
                    TAX_Utilities_v2.FirstDay = vbNullString
        ...
        End If
    ElseIf strKieuKy = KIEU_KY_QUY Then
        TAX_Utilities_v2.month = vbNullString
        TAX_Utilities_v2.ThreeMonths = cmbQuy.Text
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "74" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "75" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "23" Then
            TAX_Utilities_v2.FirstDay = txtNgayDau.Text
            TAX_Utilities_v2.LastDay = txtNgayCuoi.Text
        Else
            TAX_Utilities_v2.FirstDay = vbNullString
        ...
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "73" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "56" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "55" Then
            If strLoaiTKThang_PS = "TK_LANPS" Then
                ...
                TAX_Utilities_v2.month = txtMonth.Text
            Else
                TAX_Utilities_v2.Day = vbNullString
                TAX_Utilities_v2.month = vbNullString
            End If
        End If
' phuc vu an chi
' dhdang comment to khai nao???
    ElseIf strKieuKy = "H_Y" Then
        If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "68" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "14" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "13" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "65" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "18" Then
            If strQuy = "TK_THANG" Then
                TAX_Utilities_v2.month = txtMonth.Text
            Else
                TAX_Utilities_v2.month = vbNullString
 ...
 ' end
    ...
    ElseIf strKieuKy = KIEU_KY_NAM Then
        ...
        Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "77" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "88" Then
            TAX_Utilities_v2.FirstDay = txtNgayDau.Text
            TAX_Utilities_v2.LastDay = txtNgayCuoi.Text
        ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "76" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "59" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "43" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "41" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "17" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "26" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "45" Then
            ' QT TNCN
            TAX_Utilities_v2.FirstDay = txtNgayDau.Text
            TAX_Utilities_v2.LastDay = txtNgayCuoi.Text
        Else
  ...
  ' htphuong add them to khai 05/GTGT
    ...
    If TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "15" Then
            If ExistTokhai("02B_TNCN10_", False, TAX_Utilities_v2.month & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0126", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
     ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "16" Then
            If ExistTokhai("02A_TNCN10_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
    ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "53" Then
            If ExistTokhai("02B_TNCN_", True, TAX_Utilities_v2.month & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
    ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "37" Then
            If ExistTokhai("02A_TNCN_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
     ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "50" Then
            If ExistTokhai("03B_TNCN10_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0126", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
     ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "51" Then
            If ExistTokhai("03A_TNCN10_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
     ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "54" Then
            If ExistTokhai("03B_TNCN_", True, TAX_Utilities_v2.month & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
     ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "38" Then
            If ExistTokhai("03A_TNCN_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
     ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "39" Then
            If ExistTokhai("04B_TNCN_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0126", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
     ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "40" Then
            If ExistTokhai("04A_TNCN_", True, TAX_Utilities_v2.month & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
    ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "46" Then
            If ExistTokhai("01B_TNCN_BH_", False, TAX_Utilities_v2.month & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0126", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
     ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "47" Then
            If ExistTokhai("01A_TNCN_BH_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            End If
    ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "48" Then

        If ExistTokhai("01B_TNCN_XS_", False, TAX_Utilities_v2.month & TAX_Utilities_v2.Year) = True Then
            DisplayMessage "0126", msOKOnly, miWarning
            Unload Me
            frmTreeviewMenu.Show
            Exit Sub
    ...
    ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "49" Then

        If ExistTokhai("01A_TNCN_XS_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
            DisplayMessage "0125", msOKOnly, miWarning
            Unload Me
            frmTreeviewMenu.Show
            Exit Sub
    ...
    ElseIf TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "01" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "02" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "04" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "71" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "25" Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "96" _
    Or TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ID").nodeValue = "94" Then

        If strQuy = "TK_QUY" Then
            If ExistTokhai(GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_", True, TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0125", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
            ...
            ElseIf strQuy = "TK_THANG" Then
                If ExistTokhai(GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_Q", False, TAX_Utilities_v2.month & TAX_Utilities_v2.Year) = True Then
                DisplayMessage "0126", msOKOnly, miWarning
                Unload Me
                frmTreeviewMenu.Show
                Exit Sub
    ...
    If idToKhai = "68" Or idToKhai = "14" Or idToKhai = "13" Or idToKhai = "65" Or idToKhai = "18" Then
        If strQuy = "TK_THANG" Then
            dNgayDau = DateSerial(CInt(Mid$(TAX_Utilities_v2.FirstDay, 7, 4)), CInt(Mid$(TAX_Utilities_v2.FirstDay, 4, 2)), CInt(Mid$(TAX_Utilities_v2.FirstDay, 1, 2)))
            dNgayCuoi = DateSerial(CInt(Mid$(TAX_Utilities_v2.LastDay, 7, 4)), CInt(Mid$(TAX_Utilities_v2.LastDay, 4, 2)), CInt(Mid$(TAX_Utilities_v2.LastDay, 1, 2)))

            dNgayDauQuy = DateSerial(CInt(TAX_Utilities_v2.Year), CInt(TAX_Utilities_v2.month), 1)
            Dim temp As Integer
            Dim temp1 As Date
            temp = CInt(TAX_Utilities_v2.month) + 1
            If TAX_Utilities_v2.month = "12" Then
                temp1 = DateSerial(CInt(TAX_Utilities_v2.Year) + 1, 1, 1)
                dNgayCuoiQuy = DateAdd("D", -1, temp1)
            Else
                temp1 = DateSerial(CInt(TAX_Utilities_v2.Year), temp, 1)
                dNgayCuoiQuy = DateAdd("D", -1, temp1)
            End If
...
'            dNgayDauQuy = GetNgayDauQuy(CInt(TAX_Utilities_v2.ThreeMonths), TAX_Utilities_v2.Year, 1, 1)
'            dNgayCuoiQuy = GetNgayCuoiK(CInt(TAX_Utilities_v2.ThreeMonths), TAX_Utilities_v2.Year, 1, 1)
            ' Ky bao cao tu ngay khong duoc lon hon ky bao cao den ngay
            If dNgayCuoi < dNgayDau Then
                DisplayMessage "0254", msOKOnly, miWarning
                Exit Sub
...
'            End If
        Else
            ...
            dNgayCuoi = DateSerial(CInt(Mid$(TAX_Utilities_v2.LastDay, 7, 4)), CInt(Mid$(TAX_Utilities_v2.LastDay, 4, 2)), CInt(Mid$(TAX_Utilities_v2.LastDay, 1, 2)))
            dNgayDauQuy = GetNgayDauQuy(CInt(TAX_Utilities_v2.ThreeMonths), TAX_Utilities_v2.Year, 1, 1)
            dNgayCuoiQuy = GetNgayCuoiQuy(CInt(TAX_Utilities_v2.ThreeMonths), TAX_Utilities_v2.Year, 1, 1)
            ' Ky bao cao tu ngay khong duoc lon hon ky bao cao den ngay
            If dNgayCuoi < dNgayDau Then
                DisplayMessage "0254", msOKOnly, miWarning
                Exit Sub
    ...
    If idToKhai = "11" Or idToKhai = "12" Then
        If (Val(TAX_Utilities_v2.ThreeMonths) >= 4 And Val(TAX_Utilities_v2.Year) = 2014) Or Val(TAX_Utilities_v2.Year) > 2014 Then
    ...
    If idToKhai = "73" Then
        If strLoaiTKThang_PS = "TK_THANG" Then
            If ((Val(TAX_Utilities_v2.ThreeMonths) >= 4 And Val(TAX_Utilities_v2.Year) = 2014) Or Val(TAX_Utilities_v2.Year) > 2014) Or strKHBS = "TKBS" Then
                DisplayMessage "0341", msOKOnly, miWarning
                cmbQuy.SetFocus
                Exit Sub
            End If
    ...
    If strKHBS = "TKCT" And strKieuKy = KIEU_KY_NAM Then
        If idToKhai = "93" Or idToKhai = "89" Then
            If checkKyKKTrung(GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk, Trim(txtNgayDau.Text), Trim(txtNgayCuoi.Text), txtYear.Text) = True Then
        ...
        Else
            If checkKyKKTrung(GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile"), Trim(txtNgayDau.Text), Trim(txtNgayCuoi.Text), txtYear.Text) = True Then
                DisplayMessage "0340", msOKOnly, miWarning
                Exit Sub
            End If
        End If
    ElseIf strKHBS = "TKBS" And strKieuKy = KIEU_KY_NAM Then
        If idToKhai = "93" Or idToKhai = "89" Then
            If checkKyKKTrung("bs" & Trim$(txtSolan.Text) & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk, Trim(txtNgayDau.Text), Trim(txtNgayCuoi.Text), txtYear.Text) = True Then
                DisplayMessage "0340", msOKOnly, miWarning
                Exit Sub
            End If
        ' to khai 09/TNCN khong check
        ElseIf idToKhai = "41" Or idToKhai = "76" Then
        Else
            If checkKyKKTrung("bs" & Trim$(txtSolan.Text) & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile"), Trim(txtNgayDau.Text), Trim(txtNgayCuoi.Text), txtYear.Text) = True Then
                DisplayMessage "0340", msOKOnly, miWarning
                Exit Sub
            End If
        End If
    ...
    If strKHBS = "TKCT" Then
        If idToKhai = "03" Then
            If checkKyKKTrungNgay(GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile"), Trim(txtNgayDau.Text), Trim(txtNgayCuoi.Text), Trim$(txtYear.Text)) = True Then
    ...
    ElseIf strKHBS = "TKBS" Then
        If idToKhai = "03" Then
            If checkKyKKTrungNgay("bs" & Trim$(txtSolan.Text) & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile"), Trim(txtNgayDau.Text), Trim(txtNgayCuoi.Text), Trim$(txtYear.Text)) = True Then
                DisplayMessage "0344", msOKOnly, miWarning
                Exit Sub
            End If
        End If
...
'            If checkKyKKTrungNgay(GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile"), Trim(txtNgayDau.Text), Trim(txtNgayCuoi.Text)) = True Then
'                DisplayMessage "0344", msOKOnly, miWarning
'                Exit Sub
'            End If
'        End If
'    ElseIf strKHBS = "TKBS" Then
'        If idToKhai = "80" Or idToKhai = "82" Then
'            If checkKyKKTrungNgay("bs" & Trim$(txtSolan.Text) & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile"), Trim(txtNgayDau.Text), Trim(txtNgayCuoi.Text)) = True Then
'                DisplayMessage "0344", msOKOnly, miWarning
'                Exit Sub
'            End If
'        End If
'    End If
    ...
    If strKHBS = "TKBS" And (InStr(1, strIdKHBS_TT156, "~" & Trim$(idToKhai) & "~", vbTextCompare) > 0 Or idToKhai = "01") Then
        ...
        If Trim(TAX_Utilities_v2.month) <> "" Then
            ' to khai nha thau nuoc ngoai
            If idToKhai = "70" Or idToKhai = "55" Or idToKhai = "06" Or idToKhai = "81" Or idToKhai = "90" Or idToKhai = "05" Then
                If strLoaiTKThang_PS = "TK_THANG" Then
            ...
            ElseIf idToKhai = "72" Then
                ...
                ElseIf strLoaiTKThang_PS = "TK_LANPS" Then
                    strDataFileBS = TAX_Utilities_v2.DataFolder & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Day & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                End If
            ElseIf idToKhai = "73" Or idToKhai = "56" Then
                If strLoaiTKThang_PS = "TK_LANPS" Then
                    strDataFileBS = TAX_Utilities_v2.DataFolder & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Day & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                Else
...
'                End If
            ...
            Else
                strDataFileBS = TAX_Utilities_v2.DataFolder & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
            End If
        ElseIf Trim(TAX_Utilities_v2.ThreeMonths) <> "" Then
            If idToKhai = "55" Then
                If strLoaiTKThang_PS = "TK_THANG" Then
                    strDataFileBS = TAX_Utilities_v2.DataFolder & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                ElseIf strLoaiTKThang_PS = "TK_NAM" Then
            ...
            Else
                strDataFileBS = TAX_Utilities_v2.DataFolder & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_0" & TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year & ".xml"
            End If
        ElseIf Trim(TAX_Utilities_v2.Year) <> "" Then
...
'            Else
            ...
            ElseIf idToKhai = "93" Or idToKhai = "89" Then
                strDataFileBS = TAX_Utilities_v2.DataFolder & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk & "_" & TAX_Utilities_v2.Year & "_" & Replace(TAX_Utilities_v2.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_v2.LastDay, "/", "") & ".xml"
            ElseIf idToKhai = "84" Then
                strDataFileBS = TAX_Utilities_v2.DataFolder & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Year & ".xml"
            Else
                strDataFileBS = TAX_Utilities_v2.DataFolder & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Year & "_" & Replace(TAX_Utilities_v2.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_v2.LastDay, "/", "") & ".xml"
            End If
        End If
        ...
        If strLoaiTKThang_PS = "TK_LANPS" Then
            If idToKhai = "98" Or idToKhai = "92" Then
                hnps = DateAdd("D", 35, DateSerial(CInt(TAX_Utilities_v2.Year), CInt(TAX_Utilities_v2.month), CInt(TAX_Utilities_v2.Day)))
            Else
                hnps = DateAdd("D", 10, DateSerial(CInt(TAX_Utilities_v2.Year), CInt(TAX_Utilities_v2.month), CInt(TAX_Utilities_v2.Day)))
            End If
    ...
    If idToKhai = "41" Then
        If TAX_Utilities_v2.Year = "2012" Then
            SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(4), "Active", "1"
        End If
    End If
...
'    Debug.Print "Ket thuc load" & Time
    ...
    If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "45" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "52" Then
...
'        End If
    ...
    If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "15" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "16" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "37" _
            Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "38" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "39" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "40" _
                 Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "42" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "44" _
                    Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "46" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "47" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "48" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "49" _
                        Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "50" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "51" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "53" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "54" _
                        Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "74" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "75" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "24" Then
        SetupLayoutTNCN (strKieuKy)
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "76" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "59" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "43" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "41" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "17" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "26" Then
        SetupLayoutTNCN_QT
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "45" Then
        SetupLayoutTNCN_HT_IN_QT
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "99" Then
        SetupLayoutTNDN_DK (strKieuKy)
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "02" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "01" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "04" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "36" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "25" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "96" _
    Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "94" Then
        SetLayoutToKhaiThangQuy
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "71" Then
        SetLayoutToKhaiThangQuyLanPS
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "11" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "12" _
    Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "86" _
     Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "83" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "85" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "84" Then
        SetupLayoutGTGT strKieuKy, GetAttribute(TAX_Utilities_v2.NodeMenu, "ID")
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "70" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "72" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "06" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "81" Then
        SetupLayoutNTNN
    ...
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "90" Then
        SetupLayout01TBVMT
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "03" Then
        SetupLayout03TNDN
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "87" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "88" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "97" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "77" Then
        SetupLayout02BVMT
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "80" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "82" Then
        SetupLayout02NTNN
'    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "74" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "75" Then
'        SetupLayout08TNCN
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "91" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "64" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "07" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "27" Then
        SetupLayout04TBAC
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "92" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "98" Then
        SetupLayout01_TAIN_DK
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "93" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "89" Then
        SetupLayout02_TNDN_DK
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "23" Then
        SetupLayout01TTS
    ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "68" Then
        SetupLayoutBC26
...
Private Sub SetupLayout(strKieuKy As String)
    ...
    Select Case strKieuKy
        ...
        Case KIEU_KY_QUY
            ...
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "PopID") = "101" Then
        ...
        Case "H_Y"
            ...
            lblQuy.Top = 300
            lblQuy.Left = 120
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "68" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "65" Then
                lblQuy.caption = "Ky`"
            End If
    ...
    Select Case strKieuKy
        ...
        Case KIEU_KY_QUY
            ...
            Else
                ...
                cmbQuy.ListIndex = q.q - 1
                If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "73" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "56" Then
                Else
                    txtYear.Text = q.Y
                End If
            End If
        ...
        Case "H_Y"
            ...
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "68" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "14" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "13" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "65" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "18" Then
                q = GetQuyHienTai(iNgayTaiChinh, iThangTaiChinh)
        ...
        Case KIEU_KY_NAM
            ...
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "93" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "89" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "87" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "97" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "77" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "88" Then
                Y = GetNamHienTai(iNgayTaiChinh, iThangTaiChinh)
                Y = Y - 1
                txtYear.Text = Y
            ...
            ElseIf GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "24" Then
                Y = GetNamHienTai(iNgayTaiChinh, iThangTaiChinh)
                txtYear.Text = Y
            Else
                Y = GetNamHienTai(iNgayTaiChinh, iThangTaiChinh)
                Y = Y - 1
                txtYear.Text = Y
                If GetAttribute(TAX_Utilities_v2.NodeMenu, "ParentID") = "101_10" Then
                    txtNgayDau.Text = "01/" & Y
                    txtNgayCuoi.Text = "12/" & Y
                End If
            End If
        ...
        Case KIEU_KY_NGAY_THANG
            ...
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "91" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "64" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "07" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "92" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "98" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "27" Then
                txtDay.Text = d
                txtMonth.Text = m
                txtYear.Text = Y
        ...
        Case KIEU_KY_NGAY_PS
            txtYear.Text = Y
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "05" Then
                    txtMonth.Text = m - 1
                    If Len(txtMonth.Text) = 1 Then
                        txtMonth.Text = "0" & txtMonth.Text
                    End If
...
Private Sub OptBosung_Click()
    ...
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_11") Or ((TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_15")) Or varMenuId = "02" Or varMenuId = "01" Or varMenuId = "04" Or varMenuId = "11" Or varMenuId = "12" Or varMenuId = "06" Or varMenuId = "05" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "71" Or varMenuId = "72" Or varMenuId = "73" Or varMenuId = "56" Or varMenuId = "84" _
    Or varMenuId = "03" Or varMenuId = "77" Or varMenuId = "80" Or varMenuId = "81" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "82" Or varMenuId = "86" Or varMenuId = "90" Or varMenuId = "87" Or varMenuId = "83" Or varMenuId = "85" Or varMenuId = "90" Or varMenuId = "88" Or varMenuId = "92" Or varMenuId = "93" Or varMenuId = "89" Or varMenuId = "94" Or varMenuId = "96" Or varMenuId = "97" Or varMenuId = "98" Or varMenuId = "99" Or varMenuId = "24" Then
        For i = 1 To 50
            ...
            If (varMenuId = "46" Or varMenuId = "48" Or varMenuId = "15" Or varMenuId = "50" Or varMenuId = "39" Or varMenuId = "36" Or varMenuId = "25" Or varMenuId = "53" Or varMenuId = "54" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "02" Or varMenuId = "01" Or varMenuId = "04" Or varMenuId = "06" Or varMenuId = "05" Or varMenuId = "71" _
            Or varMenuId = "72" Or varMenuId = "81" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "83" Or varMenuId = "85" Or varMenuId = "86" Or varMenuId = "90" Or varMenuId = "90" Or varMenuId = "92" Or varMenuId = "89" Or varMenuId = "94" Or varMenuId = "98" Or varMenuId = "96") Then
                If varMenuId = "70" Or varMenuId = "55" Or varMenuId = "06" Or varMenuId = "90" Then
                    If strLoaiTKThang_PS = "TK_THANG" Then
                        strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Day & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                    ElseIf strLoaiTKThang_PS = "TK_NAM" Then
                        strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Year & ".xml"
                    ElseIf strLoaiTKThang_PS = "TK_LANPS" Then
                        strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                    End If
...
'                    If strLoaiTKThang_PS = "TK_THANG" Then
'                        strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk & "_" & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
'                    ElseIf strLoaiTKThang_PS = "TK_LANPS" Then
'                        strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk & "_" & TAX_Utilities_v2.Day & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
'                    End If
                     If strQuy = "TK_THANG" Then
                          strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk & "_" & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                     ElseIf strQuy = "TK_LANPS" Then
                          strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk & "_" & TAX_Utilities_v2.Day & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                     ElseIf strQuy = "TK_LANXB" Then
                          strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk & "_L" & strSoLanXuatBan & "_" & TAX_Utilities_v2.Day & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                     End If
                Else
                    strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                End If
            ElseIf (varMenuId = "47" Or varMenuId = "49" Or varMenuId = "16" Or varMenuId = "37" Or varMenuId = "51" Or varMenuId = "38" Or varMenuId = "40") Then
                strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_0" & TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year & ".xml"
            ElseIf varMenuId = "11" Or varMenuId = "12" Or varMenuId = "73" Or varMenuId = "56" Then
                strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_0" & TAX_Utilities_v2.ThreeMonths & TAX_Utilities_v2.Year & ".xml"
            ElseIf varMenuId = "03" Or varMenuId = "87" Or varMenuId = "88" Or varMenuId = "97" Then
                strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Year & "_" & Replace(TAX_Utilities_v2.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_v2.LastDay, "/", "") & ".xml"
'            ElseIf varMenuId = "77" Then
'                strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Year & ".xml"
            ElseIf varMenuId = "93" Or varMenuId = "89" Then
                strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & strLoaiTkDk & "_" & TAX_Utilities_v2.Year & ".xml"
'            ElseIf varMenuId = "89" Then
'                strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Year & ".xml"
            ElseIf varMenuId = "80" Or varMenuId = "82" Then
                strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & Replace(TAX_Utilities_v2.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_v2.LastDay, "/", "") & ".xml"
            ElseIf varMenuId = "24" Or varMenuId = "84" Then
                strDataFileName = TAX_Utilities_v2.DataFolder & "bs" & i & "_" & GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(0), "DataFile") & "_" & TAX_Utilities_v2.Year & ".xml"
            End If
        ...
        If OptBosung.value = True Then
            ...
            If varMenuId = "02" Or varMenuId = "01" Or varMenuId = "04" Or varMenuId = "11" Or varMenuId = "12" Or varMenuId = "06" Or varMenuId = "05" Or varMenuId = "71" Or varMenuId = "72" Or varMenuId = "73" Or varMenuId = "56" Or varMenuId = "03" _
            Or varMenuId = "77" Or varMenuId = "80" Or varMenuId = "81" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "82" Or varMenuId = "83" Or varMenuId = "85" Or varMenuId = "84" Or varMenuId = "86" Or varMenuId = "87" Or varMenuId = "90" Or varMenuId = "88" Or varMenuId = "92" Or varMenuId = "93" Or varMenuId = "89" Or varMenuId = "94" Or varMenuId = "96" Or varMenuId = "97" Or varMenuId = "98" Or varMenuId = "99" Then
                Frame2.Visible = False
                lblSelectAll.Visible = False
                chkSelectAll.Visible = False
                fpSpread1.Visible = False
                fpsNgaykhaiBS.Visible = True
                If varMenuId = "73" Or varMenuId = "56" Then
                    frmKy.Height = 1800
                    Frame2.Top = 1600
                ...
                ElseIf varMenuId = "03" Or varMenuId = "88" Or varMenuId = "87" Or varMenuId = "97" Or varMenuId = "93" Or varMenuId = "89" Or varMenuId = "77" Then
                    ...
                    fpsNgaykhaiBS.Left = 960
                ElseIf varMenuId = "81" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "06" Or varMenuId = "90" Or varMenuId = "72" Then
                    frmKy.Height = 2050
                    Frame2.Top = 2100
                    Set fpsNgaykhaiBS.Container = frmKy
...
'                    cboNganhKD.Left = 120
        ...
        Else
            ...
            strSolanBS = ""
            ' kiem tra to khai bs GTGT
            If varMenuId = "02" Or varMenuId = "01" Or varMenuId = "04" Or varMenuId = "11" Or varMenuId = "12" Or varMenuId = "06" Or varMenuId = "05" Or varMenuId = "71" Or varMenuId = "72" Or varMenuId = "73" Or varMenuId = "56" _
            Or varMenuId = "77" Or varMenuId = "86" Or varMenuId = "90" Or varMenuId = "87" Or varMenuId = "03" Or varMenuId = "83" Or varMenuId = "85" Or varMenuId = "84" Or varMenuId = "90" Or varMenuId = "88" Or varMenuId = "92" Or varMenuId = "93" Or varMenuId = "89" Or varMenuId = "94" Or varMenuId = "96" Or varMenuId = "97" Or varMenuId = "98" Or varMenuId = "99" Then
                ' to khai nao co phu luc thi moi hien thi len
                If Not fpSpread1.Visible And TAX_Utilities_v2.NodeValidity.childNodes.length > 2 Then
                    Frame2.Visible = True
                    lblSelectAll.Visible = True
                    chkSelectAll.Visible = True
                    fpSpread1.Visible = True
...
'                    cboNganhKD.Left = 120
    ...
    ElseIf (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_10") Then
        strSolanBS = ""
        ...
        With xmlDomLastData
            ...
            .async = False
                ...
                strDataFileName = TAX_Utilities_v2.DataFolder & TIEN_TO_DATA_FILE & "_" & txtYear.Text & ".xml"
...
Private Sub OptChinhthuc_Click()
    ...
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_11") Or (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_15") Or varMenuId = "02" Or varMenuId = "01" Or varMenuId = "04" Or varMenuId = "11" Or varMenuId = "12" Or varMenuId = "06" Or varMenuId = "05" Or varMenuId = "71" Or varMenuId = "72" Or varMenuId = "73" Or varMenuId = "56" _
    Or varMenuId = "03" Or varMenuId = "77" Or varMenuId = "80" Or varMenuId = "81" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "82" Or varMenuId = "83" Or varMenuId = "85" Or varMenuId = "84" Or varMenuId = "86" Or varMenuId = "87" Or varMenuId = "90" Or varMenuId = "88" Or varMenuId = "92" Or varMenuId = "93" Or varMenuId = "89" Or varMenuId = "94" Or varMenuId = "96" Or varMenuId = "97" Or varMenuId = "98" Or varMenuId = "99" Or varMenuId = "24" Or varMenuId = "93" Or varMenuId = "89" Then
        If OptBosung.value = True Then
            lblSolan.Visible = False
            txtSolan.Visible = False
            strKHBS = "TKBS"
            ...
            ' kiem tra to khai bs GTGT
            If varMenuId = "02" Or varMenuId = "01" Or varMenuId = "04" Or varMenuId = "11" Or varMenuId = "12" Or varMenuId = "06" Or varMenuId = "05" Or varMenuId = "71" Or varMenuId = "72" Or varMenuId = "73" Or varMenuId = "56" _
            Or varMenuId = "77" Or varMenuId = "80" Or varMenuId = "81" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "82" Or varMenuId = "83" Or varMenuId = "85" Or varMenuId = "84" Or varMenuId = "86" Or varMenuId = "87" Or varMenuId = "03" Or varMenuId = "90" Or varMenuId = "88" Or varMenuId = "92" Or varMenuId = "93" Or varMenuId = "89" Or varMenuId = "94" Or varMenuId = "96" Or varMenuId = "97" Or varMenuId = "98" Or varMenuId = "99" Then
                Frame2.Visible = False
                lblSelectAll.Visible = False
                chkSelectAll.Visible = False
                fpSpread1.Visible = False
...
'                    Frame2.Top = 1700
                ...
                ElseIf varMenuId = "03" Or varMenuId = "88" Or varMenuId = "93" Or varMenuId = "89" Then
                    frmKy.Height = 1740
                    Frame2.Top = 2050
                ElseIf varMenuId = "81" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "06" Or varMenuId = "72" Then
                    frmKy.Height = 1600
                    Frame2.Top = 2050
                ElseIf varMenuId = "80" Or varMenuId = "82" Then
                    frmKy.Height = 1400
...
'*************************
    If txtMonth.Text <> TAX_Utilities_v2.month Then
        LoadGrid
    End If
    
    ' set lai ngay dau ky va cuoi ky
    If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "68" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "14" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "13" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "18" Then
        If strQuy = "TK_THANG" Then
            ' set ngay dau
            txtNgayDau.Text = "01/" & txtMonth.Text & "/" & txtYear.Text
            ' set ngay cuoi
...
Private Sub txtNgayCuoi_LostFocus()
    ...
    If Len(txtNgayCuoi.Text) > 0 Then
        ...
        If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "74" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "75" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "23" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "93" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "89" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "87" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "97" _
        Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "76" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "59" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "43" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "41" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "17" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "77" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "88" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "26" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "45" Then
            ...
            Else
                ...
                If txtNgayCuoi.Text <> TAX_Utilities_v2.LastDay Then
                    If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "93" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "89" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "87" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "97" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "77" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "88" Then
                        LoadGrid
                    End If
                End If
            End If
...
Private Sub txtNgayDau_LostFocus()
    ...
    If Len(txtNgayDau.Text) > 0 Then
        ...
        ' To khai 08/TNCN va to khai 08A/TNCN set o nay tu thang den thang
        If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "74" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "75" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "23" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "93" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "89" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "87" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "97" _
        Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "76" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "59" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "43" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "41" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "17" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "77" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "88" _
        Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "26" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "45" Then
            ...
            Else
                ...
                If txtNgayDau.Text <> TAX_Utilities_v2.LastDay Then
                    If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "93" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "89" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "87" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "97" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "77" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "88" Then
                        LoadGrid
                    End If
                End If
        ...
        Else
            ...
            Else
                ...
                ' NTNN 02,04
                If txtNgayDau.Text <> TAX_Utilities_v2.FirstDay Then
                    If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "80" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "82" Then
                        LoadGrid
                    End If
                End If
...
Private Sub txtYear_LostFocus()
    ...
    If Len(txtYear.Text) > 0 Then
        ...
        End If
    End If
    If txtYear.Text <> TAX_Utilities_v2.Year And GetAttribute(TAX_Utilities_v2.NodeMenu, "Day") = "1" Then
        txtNgayCuoi.Enabled = True
        txtNgayDau.Enabled = True
    End If
    
    If txtYear.Text <> yChange And GetAttribute(TAX_Utilities_v2.NodeMenu, "Day") = "1" And txtNgayCuoi.Enabled And txtNgayDau.Enabled Then
        Call initNgayDauNgayCuoi(CInt(txtYear.Text))
    End If
    'dhdang them ky nua nam phuc vu an chi
    If txtYear.Text <> yChange And GetAttribute(TAX_Utilities_v2.NodeMenu, "Year") = "1/2" And txtNgayCuoi.Enabled And txtNgayDau.Enabled Then
        Call initNgayDauNgayCuoiKy(CInt(txtYear.Text), cmbQuy.ListIndex)
    End If
    ' end
    ' set lai tu thang den thang
    If (TAX_Utilities_v2.NodeMenu.Attributes.getNamedItem("ParentID").nodeValue = "101_10") _
    Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "77" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "87" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "88" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "97" _
    Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "93" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "89" Then
    ...
    If txtYear.Text <> TAX_Utilities_v2.Year Then
...
For lCtrl = 1 To fpSpread1.MaxRows
    fpSpread1.Row = lCtrl
    SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(lCtrl - 1), "Active", fpSpread1.value
Next lCtrl
End Sub
...
On Error GoTo ErrHandle
    ...
    With fpSpread1
        ...
        ' xu ly cho to khai DK
        strIDTkhai = GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID")
        ' end
...
'                            If strQuy = "TK_THANG" Then
'                                strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtMonth.Text & txtYear.Text & ".xml"
'                            ElseIf strQuy = "TK_LANXB" Then
'                                strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_Q0" & cmbQuy.Text & txtYear.Text & ".xml"
'                            Else
'                                strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtMonth.Text & txtYear.Text & ".xml"
'                            End If
                            
                             If strQuy = "TK_THANG" Then
                                strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & strLoaiTkDk & "_" & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                            ElseIf strQuy = "TK_LANPS" Then
                                strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & strLoaiTkDk & "_" & TAX_Utilities_v2.Day & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                            ElseIf strQuy = "TK_LANXB" Then
                                strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & strLoaiTkDk & "_L" & strSoLanXuatBan & "_" & TAX_Utilities_v2.Day & TAX_Utilities_v2.month & TAX_Utilities_v2.Year & ".xml"
                            End If
                        Else
                            If strQuy = "TK_THANG" Then
                                strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtMonth.Text & txtYear.Text & ".xml"
                    ...
                    ElseIf strKieuKy = KIEU_KY_QUY Then
                        If strQuy = "TK_TU_THANG" Then
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & TAX_Utilities_v2.FirstDay & "_" & TAX_Utilities_v2.LastDay & ".xml"
                        Else
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_0" & cmbQuy.Text & txtYear.Text & ".xml"
                        End If
                    ' phuc vu an chi
                    ElseIf strKieuKy = "H_Y" Then
                        If strQuy = "TK_THANG" Then
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_T" & txtMonth.Text & txtYear.Text & ".xml"
                        Else
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_0" & cmbQuy.Text & txtYear.Text & ".xml"
                        End If
                    ' end
                    ElseIf strKieuKy = KIEU_KY_NGAY_NAM Then
                        If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "80" Or GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "82" Then
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" _
                            & Replace(TAX_Utilities_v2.FirstDay, "/", "") & "_" & Replace(TAX_Utilities_v2.LastDay, "/", "") & ".xml"
                        Else
                            If xmlNode Is TAX_Utilities_v2.NodeValidity.firstChild Then
...
'                                        txtNgayDau.Enabled = False
                                ...
                                Next
                            Else
                                strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtYear.Text & _
                    ...
                    ElseIf strKieuKy = KIEU_KY_NAM Then
                        If GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "93" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "89" Then
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & strLoaiTkDk & "_" & txtYear.Text & "_" & Replace$(txtNgayDau.Text, "/", "") & "_" & Replace$(txtNgayCuoi.Text, "/", "") & ".xml"
                        ElseIf GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "87" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "97" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "77" _
                        Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "88" Then
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtYear.Text & "_" & Replace$(txtNgayDau.Text, "/", "") & "_" & Replace$(txtNgayCuoi.Text, "/", "") & ".xml"
                        ElseIf GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "76" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "59" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "43" _
                        Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "41" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "17" Or GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "26" Then
                            ' QT TNCN
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtYear.Text & "_" & Replace$(txtNgayDau.Text, "/", "") & "_" & Replace$(txtNgayCuoi.Text, "/", "") & ".xml"
                        ElseIf GetAttribute(TAX_Utilities_v2.NodeValidity.parentNode, "ID") = "95" Then
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_L" & strSolanKK & "_" & txtYear.Text & ".xml"
                        Else
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtYear.Text & ".xml"
                        End If
                    ElseIf strKieuKy = KIEU_KY_NGAY_THANG Then
                        If strLoaiTKThang_PS = "TK_LANPS" Then
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtDay.Text & txtMonth.Text & txtYear.Text & ".xml"
                        Else
                            strDataFileName = TAX_Utilities_v2.DataFolder & GetAttribute(xmlNode, "DataFile") & "_" & txtMonth.Text & txtYear.Text & ".xml"
                        End If
                    End If
        ...
        If Not blnExistData Then
            For lCtrl = 2 To lRow - 1
                .Row = lCtrl
                .value = GetAttribute(TAX_Utilities_v2.NodeValidity.childNodes(lCtrl - 1), "Active")
            Next lCtrl
        End If
        ...
        If Not fpSpread1.Visible And TAX_Utilities_v2.NodeValidity.childNodes.length > 2 Then
            fpSpread1.Visible = True
           ' Frame2.Visible = True
            If GetAttribute(TAX_Utilities_v2.NodeMenu, "ID") = "21" Then
                Frame2.Visible = False
            Else
               Frame2.Visible = True
            End If
...
Private Sub SetDefaultActiveProperties()
    ...
    strTemp = GetAttribute(TAX_Utilities_v2.NodeMenu, "ID")
    ...
    strTemp = GetAttribute(TAX_Utilities_v2.NodeValidity, "StartDate")
    ...
    For lCtrl = 0 To TAX_Utilities_v2.NodeValidity.childNodes.length - 1
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(lCtrl), "Active", GetAttribute(xmlNodeValidity.childNodes(lCtrl), "Active")
    Next lCtrl
...
Private Sub SetupLayout04TNDN()
    ...
    Me.Width = 4905
        ...
        Set chkTkhaiThang.Container = frmKy
        chkTkhaiThang.Top = 200
        chkTkhaiThang.caption = GetAttribute(GetMessageCellById("0354"), "Msg")
        chkTkhaiThang.Left = 120
        chkTkhaiThang.value = 1
        chkTKLanPS.value = 0
...
ErrorHandle:
    SaveErrorLog Me.Name, "SetupLayout04TNDN", Err.Number, Err.Description
        ...
        For Each xmlNode In xmlNodeListItems
            ...
            If strId = "11" Then
                If fldList(0) = "01A_TNDN" Then
                    cboNganhKD.AddItem TAX_Utilities_v2.Convert(fldList(2), UNICODE, TCVN)
...
'    For lCtrl = 1 To fpSpread1.MaxRows
'        fpSpread1.Row = lCtrl
'        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(lCtrl - 1), "Active", "0"
'    Next lCtrl
    If varMenuId = "02" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(1), "Active", 1
    ElseIf varMenuId = "01" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(6), "Active", 1
    ElseIf varMenuId = "04" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(1), "Active", 1
'    ElseIf varMenuId = "95" Then
'        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(3), "Active", 1
    ElseIf varMenuId = "73" Or varMenuId = "56" Or varMenuId = "88" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(1), "Active", 1
    ElseIf varMenuId = "90" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(2), "Active", 1
    ElseIf varMenuId = "85" Or varMenuId = "84" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(1), "Active", 1
    ElseIf varMenuId = "12" Or varMenuId = "11" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(3), "Active", 1
    ElseIf varMenuId = "06" Or varMenuId = "70" Or varMenuId = "55" Or varMenuId = "77" Or varMenuId = "05" Or varMenuId = "71" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(1), "Active", 1
    ElseIf varMenuId = "80" Or varMenuId = "89" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(3), "Active", 1
    ElseIf varMenuId = "86" Or varMenuId = "87" Or varMenuId = "72" Or varMenuId = "81" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(1), "Active", 1
    ElseIf varMenuId = "03" Then
        SetAttribute TAX_Utilities_v2.NodeValidity.childNodes(15), "Active", 1

...
'Bang ke 310
'str2 = "aa324274200536821   07201400100100100101/0101/01/2009<S01><S>Hãa ®¬n gi¸ trÞ gia t¨ng~01GTKT2/001~QS/11T~0000100~0000345~246~0~Hãa ®¬n b¸n hµng dù tr÷ quèc gia~01BHDT2/001~QS/12T~0000123~0000324~202~0</S><S>dai dien~24/07/2014</S></S01>"
'Barcode_Scaned str2
...
On Error GoTo ErrHandle
    ...
    ElseIf GetAttribute(TAX_Utilities_iNTK.NodeMenu, "ThreeMonth") = 1 Then
        ...
        '//Fix for iHTKK
        If (strID = "66" Or strID = "67") Then
            If (CInt(TAX_Utilities_iNTK.ThreeMonths) > 4) Then
                TAX_Utilities_iNTK.ThreeMonths = "04"
            End If
        End If
    End If

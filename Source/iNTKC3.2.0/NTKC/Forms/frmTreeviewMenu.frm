...
Private Sub ProcessMenuAction(pID As String)
    ...
    Select Case pID
        ...
        Case "100_2" ' Tra cuu
            frmTraCuu.Show
            Exit Sub
        Case "100_3" ' Tra cuu iHTKK
            frmTraCuuiHTKK.Show
            Exit Sub
        Case "100_4" ' Tra cuu iHTKK
            frmTraCuuError.Show
            Exit Sub
	 Case "100_5" ' Tra cuu tk loi
            frmTraCuuAC.Show vbModal
            Exit Sub    
        Case "100_3" ' Tra cuu tk loi
            frmTraCuuError.Show
            Exit Sub
        Case "100_6" ' Tra cuu mau an chi loi
            frmTraCuuACError.Show vbModal
            Exit Sub
        Case "102_1" ' thoat
            Exit Sub
        Case "102_2" ' thong ke
        ...
        Case "101_1"
            ...
            Else
                blnMenuHide = False
            End If
        Case "101_3" ' Truyen nhan to khai
            If isPITActive = True Then
                frmTruyennhanTK.Show
            Else
                DisplayMessage "0109", msOKOnly, miInformation
            End If
            Exit Sub
        Case "101_2"

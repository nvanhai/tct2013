...
' Bien luu gia tri cua file
Public strDataFile123 As String
...
Public Function GetValidityNode() As MSXML.IXMLDOMNode
    ...
    Else
        ...
        ElseIf GetAttribute(TAX_Utilities_Srv_New.NodeMenu, "ThreeMonth") = "1" Then
            Select Case TAX_Utilities_Srv_New.ThreeMonths
                Case "01", "02", "03", "04"
                    ValidityDate = GetNgayCuoiQuy(CInt(TAX_Utilities_Srv_New.ThreeMonths), _
                                CInt(TAX_Utilities_Srv_New.Year), iNgayTaiChinh, iThangTaiChinh)
            End Select
...
Public Function changeMaLoaiToKhai(strID As String) As String
    ...
    If strID = "02" Then changeMaLoaiToKhai = "02/GTGT"
    If strID = "04" Then changeMaLoaiToKhai = "03/GTGT"
    If strID = "07" Then changeMaLoaiToKhai = "04_GTGT"
    
    If strID = "11" Then changeMaLoaiToKhai = "01A/TNDN"
    If strID = "12" Then changeMaLoaiToKhai = "01B/TNDN"
    If strID = "03" Then changeMaLoaiToKhai = "03/TNDN"
    If strID = "14" Then changeMaLoaiToKhai = "05_TNDN"
    If strID = "06" Then changeMaLoaiToKhai = "01/TAIN"
    If strID = "09" Then changeMaLoaiToKhai = "02_TAIN"
    If strID = "08" Then changeMaLoaiToKhai = "03_TAIN"
    If strID = "05" Then changeMaLoaiToKhai = "01/TTDB"
    
    If strID = "73" Then changeMaLoaiToKhai = "02/TNDN"
    
    If strID = "70" Then changeMaLoaiToKhai = "01/NTNN"
    If strID = "80" Then changeMaLoaiToKhai = "02/NTNN"
    If strID = "81" Then changeMaLoaiToKhai = "03/NTNN"
    If strID = "82" Then changeMaLoaiToKhai = "04/NTNN"
    
    If strID = "71" Then changeMaLoaiToKhai = "04/GTGT"
    If strID = "72" Then changeMaLoaiToKhai = "05/GTGT"
    If strID = "86" Then changeMaLoaiToKhai = "01/BVMT"
    If strID = "87" Then changeMaLoaiToKhai = "02/BVMT"
    If strID = "77" Then changeMaLoaiToKhai = "02/TAIN"
    
    If strID = "89" Then changeMaLoaiToKhai = "01/PHXD"
    
    If strID = "46" Then changeMaLoaiToKhai = "01A/TNCN_BH"
    If strID = "47" Then changeMaLoaiToKhai = "01B/TNCN_BH"
    If strID = "48" Then changeMaLoaiToKhai = "01A/TNCN_XS"
    If strID = "49" Then changeMaLoaiToKhai = "01B/TNCN_XS"
    
    If strID = "15" Then changeMaLoaiToKhai = "02A/TNCN"
    If strID = "16" Then changeMaLoaiToKhai = "02B/TNCN"
    If strID = "53" Then changeMaLoaiToKhai = "02A_TNCN"
    If strID = "37" Then changeMaLoaiToKhai = "02B_TNCN"
    
    If strID = "50" Then changeMaLoaiToKhai = "03A/TNCN"
    If strID = "51" Then changeMaLoaiToKhai = "03B/TNCN"
    If strID = "54" Then changeMaLoaiToKhai = "03A_TNCN"
    If strID = "38" Then changeMaLoaiToKhai = "03B_TNCN"
    
    If strID = "39" Then changeMaLoaiToKhai = "04A_TNCN"
    If strID = "40" Then changeMaLoaiToKhai = "04B_TNCN"
    
    If strID = "36" Then changeMaLoaiToKhai = "07/TNCN"
    
    If strID = "74" Then changeMaLoaiToKhai = "08/TNCN"
    If strID = "75" Then changeMaLoaiToKhai = "08A/TNCN"
    
    If strID = "17" Then changeMaLoaiToKhai = "05/TNCN"
    If strID = "59" Then changeMaLoaiToKhai = "06/TNCN"
    If strID = "41" Then changeMaLoaiToKhai = "09/TNCN"
    If strID = "76" Then changeMaLoaiToKhai = "08B/TNCN"
    If strID = "42" Then changeMaLoaiToKhai = "02/TNCN_BH"
    If strID = "43" Then changeMaLoaiToKhai = "02/TNCN_XS"
    
    If strID = "18" Then changeMaLoaiToKhai = "15/BCTC"
    If strID = "69" Then changeMaLoaiToKhai = "15/BCTC10"
    If strID = "19" Then changeMaLoaiToKhai = "48/BCTC"
    If strID = "20" Then changeMaLoaiToKhai = "16/BCTC"
    If strID = "21" Then changeMaLoaiToKhai = "99/BCTC"
    
    
    ' nvhai
    ' Xu ly nhac cac BCTC in bang HTKK 2.1.0
    
    If strID = "55" Then changeMaLoaiToKhai = "15_01_CDKT"
    If strID = "56" Then changeMaLoaiToKhai = "15_02_SXKD"
    If strID = "57" Then changeMaLoaiToKhai = "15_03_LCTTTT"
    If strID = "58" Then changeMaLoaiToKhai = "15_04_LCTTGT"
    If strID = "24" Then changeMaLoaiToKhai = "48_01_CDKT"
    If strID = "25" Then changeMaLoaiToKhai = "48_02_SXKD"
    If strID = "26" Then changeMaLoaiToKhai = "48_03_LCTTTT"
    If strID = "27" Then changeMaLoaiToKhai = "48_04_LCTTGT"
    If strID = "28" Then changeMaLoaiToKhai = "16_01_CDKT"
    If strID = "29" Then changeMaLoaiToKhai = "16_02_SXKD"
    If strID = "30" Then changeMaLoaiToKhai = "16_03_LCTTTT"
    If strID = "31" Then changeMaLoaiToKhai = "16_04_LCTTGT"
    If strID = "32" Then changeMaLoaiToKhai = "99_01_CDKT"
    If strID = "33" Then changeMaLoaiToKhai = "99_02_SXKD"
    If strID = "34" Then changeMaLoaiToKhai = "99_03_LCTTTT"
    If strID = "35" Then changeMaLoaiToKhai = "99_04_LCTTGT"
    
    ' Cac mau an chi
    If strID = "64" Then changeMaLoaiToKhai = "01/TBAC"
    If strID = "65" Then changeMaLoaiToKhai = "01/AC"
    If strID = "66" Then changeMaLoaiToKhai = "BC21/AC"
    If strID = "67" Then changeMaLoaiToKhai = "03/TBAC"
    If strID = "68" Then changeMaLoaiToKhai = "BC26/AC"
    If strID = "91" Then changeMaLoaiToKhai = "04/TBAC"
End Function

...
Public Const SqlHdr_TNCN = "INSERT INTO RCV_TKHAI_HDR(ID,KKBS,TIN,TEN_DTNT,DIA_CHI,LOAI_TKHAI,NGAY_NOP,KYLB_TU_NGAY,KYLB_DEN_NGAY,KYKK_TU_NGAY,KYKK_DEN_NGAY,NGAY_CAP_NHAT,NGUOI_CAP_NHAT,CO_LOI_DDANH,SO_HIEU_TEP,SO_TT_TK,DA_NHAN,GHI_CHU_LOI,CO_GTRINH_02A,CO_GTRINH_02B,CO_GTRINH_02C, CO_PLUC_GTGT_01, CO_PLUC_GTGT_02, CO_PLUC_GTGT_03, TU_NGAY, DEN_NGAY, PHONG_XLY, CO_BANG_KE, CO_GHAN, TT_GUI,HTHUC_NOP,ITKHAI_ID,TIN_DLY,SO_HOP_DONG,NGAY_HOP_DONG,LAN_BS) VALUES("
Public Const SqlHdr_08TNCN_PIT = "INSERT INTO RCV_TKHAI_HDR(ID,KKBS,TIN,TEN_DTNT,DIA_CHI,LOAI_TKHAI,NGAY_NOP,KYLB_TU_NGAY,KYLB_DEN_NGAY,KYKK_TU_NGAY,KYKK_DEN_NGAY,NGAY_CAP_NHAT,NGUOI_CAP_NHAT,CO_LOI_DDANH,SO_HIEU_TEP,SO_TT_TK,DA_NHAN,GHI_CHU_LOI,CO_GTRINH_02A,CO_GTRINH_02B,CO_GTRINH_02C, CO_PLUC_GTGT_01, CO_PLUC_GTGT_02, CO_PLUC_GTGT_03, TU_NGAY, DEN_NGAY, PHONG_XLY, CO_BANG_KE, CO_GHAN, TT_GUI,HTHUC_NOP,ITKHAI_ID,TIN_DLY,SO_HOP_DONG,NGAY_HOP_DONG,LAN_BS,NGANH_NGHE_KD,TO_KHAI_LAN_PS) VALUES("
Public Const SqlHdr_08TNCN = "INSERT INTO RCV_TKHAI_HDR(ID,KKBS,TIN,TEN_DTNT,DIA_CHI,LOAI_TKHAI,NGAY_NOP,KYLB_TU_NGAY,KYLB_DEN_NGAY,KYKK_TU_NGAY,KYKK_DEN_NGAY,NGAY_CAP_NHAT,NGUOI_CAP_NHAT,CO_LOI_DDANH,SO_HIEU_TEP,SO_TT_TK,DA_NHAN,GHI_CHU_LOI,CO_GTRINH_02A,CO_GTRINH_02B,CO_GTRINH_02C, CO_PLUC_GTGT_01, CO_PLUC_GTGT_02, CO_PLUC_GTGT_03, TU_NGAY, DEN_NGAY, PHONG_XLY, CO_BANG_KE, CO_GHAN,HTHUC_NOP,ITKHAI_ID,TIN_DLY,SO_HOP_DONG,NGAY_HOP_DONG,LAN_BS,NGANH_NGHE_KD,TO_KHAI_LAN_PS) VALUES("
